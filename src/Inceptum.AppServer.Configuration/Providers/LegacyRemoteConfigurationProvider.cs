...
{
    public class LegacyRemoteConfigurationProvider : IConfigurationProvider
    {
        ...
        public LegacyRemoteConfigurationProvider(string serviceUrl)
            : this(serviceUrl, ".")
        {
        }

        public LegacyRemoteConfigurationProvider(string serviceUrl,  string path)
            : this(serviceUrl,  path, NullLogger.Instance)
        {
        }

        public LegacyRemoteConfigurationProvider(string serviceUrl,  string path, ILogger logger)
        ...
        protected internal LegacyRemoteConfigurationProvider(FileSystemConfigurationProvider fileSystemConfigurationProvider, IConfigurationProvider externalProvider,ILogger logger)
        {
