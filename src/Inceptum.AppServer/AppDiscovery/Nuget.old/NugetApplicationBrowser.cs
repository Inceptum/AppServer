...
using NuGetLogger=NuGet.ILogger;

namespace Inceptum.AppServer.AppDiscovery.Nuget.old
{
    public class NugetApplicationBrowser : IApplicationBrowser, NuGetLogger
    {
...
/*
        ...
        void NuGetLogger.Log(MessageLevel level, string message, params object[] args)
        {
            switch (level)
            {
